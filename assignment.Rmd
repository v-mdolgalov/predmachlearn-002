...
_Features/Variables Selection_
...
print(concat0("# of records in validation data set is: ", nrow(validation)))
...
```{r}
set.seed(222)
rfModel<- train(classe~., data=trsm1[,-c(1,2)], method="rf", prox=TRUE) ## small subset of rows but with proper bootstrapping of variables
rfModel
